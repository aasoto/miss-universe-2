...
@section('content')
            ...
            <div class="container z-10">
                <div class="flex flex-wrap justify-center -mx-3">
                    <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                        <h1 class="mt-12 mb-2 text-white">Actualizar comité nacional</h1>
                        <p class="text-white">
                ...
                <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-8/12 lg:w-1/12 xl:w-1/12">
                    <div
                        ...
                        <div class="flex-auto p-6">
                            <form role="form text-left" action="{{ route('nationalcommittees.update', $nationalcommittee->id) }}"
    ...
    {{--<br>
    <form class="form-grid" action="{{ route('nationalcommittees.update', $nationalcommittee->id) }}" method="post"
