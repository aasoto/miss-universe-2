                            ...
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        ...
                                        <i class="fas fa-female text-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('nationalcommittees.index') }}">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                        <i class="fas fa-store text-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('news.index') }}">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                        <i class="fas fa-newspaper text-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('carrousel.index') }}">
                            <div class="flex flex-row -mx-3">
                                ...
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                        <i class="fas fa-images text-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </a>
